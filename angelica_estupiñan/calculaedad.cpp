...
{
	int aa,ma,da,an,mn,dn,a,m,d;//declaramos todos los  variables que se va utilizar
	cout<<"ingrese la fecha actual: ";//muestra mensaje al usuario en pantalla  para que ingrese
	...
	if(ma>mn){//utilizamos cuando  si es verdadero
		m=ma-mn;//escribimos el mes general para calcular
